...
[![DockerHub HBase](https://img.shields.io/badge/DockerHub-buildscale%2Fhbase-blue)](https://hub.docker.com/repository/docker/buildscale/hbase)
...
```
docker run -ti buildscale/hbase
```
